...
EXPLAIN (costs off) SELECT * FROM foo WHERE b = 35;
...
EXPLAIN (costs off) SELECT * FROM foo WHERE b IN (5, 6, 14, 23);
...
EXPLAIN (costs off) SELECT * FROM foo WHERE b < 15 OR b > 60;
...
EXPLAIN (costs off) SELECT * FROM foo WHERE b = 150;
...
EXPLAIN (costs off) SELECT * FROM foo WHERE b = a*5;
