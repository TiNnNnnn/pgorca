...
SELECT "operation_log_id" AS "operationlogid", "log_type" AS "logtype", "log_name" AS "logname", "user_id" AS "userid", "class_name" AS "classname", "method" AS "method", "create_time" AS "createtime", "succeed" AS "succeed", "message" AS "message" FROM "sys_operation_log" WHERE 1 = 1 AND ("create_time" BETWEEN '2019-07-08 00:00:00' AND '2019-10-31 23:59:59') AND "log_type" LIKE '%d%' LIMIT 10 OFFSET 0
