...
SELECT "projects".* FROM "projects" INNER JOIN routes rs ON rs.source_id = projects.id AND rs.source_type = 'Project' WHERE (rs.path LIKE 'user1/%') /*application:test,correlation_id:75a0a5d540f63471310aefd1c8d62587*/
...
SELECT MIN("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) AND "users"."dashboard" = $4 AND "users"."created_at" BETWEEN $5 AND $6 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT MAX("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) AND "users"."dashboard" = $4 AND "users"."created_at" BETWEEN $5 AND $6 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT COUNT("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) AND "users"."dashboard" = $4 AND "users"."created_at" BETWEEN $5 AND $6 AND "users"."id" BETWEEN $7 AND $8 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT MIN("users_ops_dashboard_projects"."user_id") FROM "users_ops_dashboard_projects" INNER JOIN "users" ON "users"."id" = "users_ops_dashboard_projects"."user_id" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) AND "users_ops_dashboard_projects"."created_at" BETWEEN $4 AND $5 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
...
SELECT MIN("projects"."creator_id") FROM "projects" INNER JOIN "services" ON "services"."project_id" = "projects"."id" INNER JOIN "project_feature_usages" ON "project_feature_usages"."project_id" = "projects"."id" WHERE "services"."type" = $1 AND "services"."active" = $2 AND "project_feature_usages"."jira_dvcs_cloud_last_sync_at" IS NOT NULL AND "projects"."created_at" BETWEEN $3 AND $4 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT MAX("projects"."creator_id") FROM "projects" INNER JOIN "services" ON "services"."project_id" = "projects"."id" INNER JOIN "project_feature_usages" ON "project_feature_usages"."project_id" = "projects"."id" WHERE "services"."type" = $1 AND "services"."active" = $2 AND "project_feature_usages"."jira_dvcs_cloud_last_sync_at" IS NOT NULL AND "projects"."created_at" BETWEEN $3 AND $4 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT COUNT(DISTINCT "projects"."creator_id") FROM "projects" INNER JOIN "services" ON "services"."project_id" = "projects"."id" INNER JOIN "project_feature_usages" ON "project_feature_usages"."project_id" = "projects"."id" WHERE "services"."type" = $1 AND "services"."active" = $2 AND "project_feature_usages"."jira_dvcs_cloud_last_sync_at" IS NOT NULL AND "projects"."created_at" BETWEEN $3 AND $4 AND "projects"."creator_id" BETWEEN $5 AND $6 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
...
SELECT MAX("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) AND "users"."group_view" = $4 AND "users"."created_at" BETWEEN $5 AND $6 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT COUNT("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) AND "users"."group_view" = $4 AND "users"."created_at" BETWEEN $5 AND $6 AND "users"."id" BETWEEN $7 AND $8 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
...
SELECT MIN("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT MAX("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT COUNT("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) AND "users"."id" BETWEEN $4 AND $5 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
...
SELECT MIN("project_feature_usages"."project_id") FROM "project_feature_usages" WHERE "project_feature_usages"."jira_dvcs_cloud_last_sync_at" IS NOT NULL /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT MAX("project_feature_usages"."project_id") FROM "project_feature_usages" WHERE "project_feature_usages"."jira_dvcs_cloud_last_sync_at" IS NOT NULL /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
...
SELECT MIN("project_feature_usages"."project_id") FROM "project_feature_usages" WHERE "project_feature_usages"."jira_dvcs_server_last_sync_at" IS NOT NULL /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
...
SELECT COUNT("project_feature_usages"."project_id") FROM "project_feature_usages" WHERE "project_feature_usages"."jira_dvcs_server_last_sync_at" IS NOT NULL AND "project_feature_usages"."project_id" BETWEEN $1 AND $2 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT MIN("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) AND (group_view = 1 OR group_view IS NULL) /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT MAX("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) AND (group_view = 1 OR group_view IS NULL) /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT COUNT("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) AND (group_view = 1 OR group_view IS NULL) AND "users"."id" BETWEEN $4 AND $5 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT MIN("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) AND "users"."group_view" = $4 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT MAX("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) AND "users"."group_view" = $4 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT COUNT("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) AND "users"."group_view" = $4 AND "users"."id" BETWEEN $5 AND $6 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
...
SELECT MIN("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) AND "users"."dashboard" = $4 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT MAX("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) AND "users"."dashboard" = $4 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT COUNT("users"."id") FROM "users" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) AND "users"."dashboard" = $4 AND "users"."id" BETWEEN $5 AND $6 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT MIN("users_ops_dashboard_projects"."user_id") FROM "users_ops_dashboard_projects" INNER JOIN "users" ON "users"."id" = "users_ops_dashboard_projects"."user_id" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT MAX("users_ops_dashboard_projects"."user_id") FROM "users_ops_dashboard_projects" INNER JOIN "users" ON "users"."id" = "users_ops_dashboard_projects"."user_id" WHERE ("users"."state" IN ('active')) AND (ghost IS NOT TRUE) AND ("users"."user_type" IS NULL OR "users"."user_type" NOT IN ($1, $2, $3)) /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
...
SELECT "projects".* FROM "projects" WHERE "projects"."last_repository_updated_at" IS NOT NULL ORDER BY "projects"."last_repository_updated_at" DESC LIMIT $1 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
...
SELECT COUNT(DISTINCT "projects"."creator_id") FROM "projects" INNER JOIN "services" ON "services"."project_id" = "projects"."id" WHERE "services"."type" = $1 AND "services"."active" = $2 AND "projects"."creator_id" BETWEEN $3 AND $4 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT MIN("projects"."creator_id") FROM "projects" INNER JOIN "services" ON "services"."project_id" = "projects"."id" INNER JOIN "project_feature_usages" ON "project_feature_usages"."project_id" = "projects"."id" WHERE "services"."type" = $1 AND "services"."active" = $2 AND "project_feature_usages"."jira_dvcs_cloud_last_sync_at" IS NOT NULL /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT MAX("projects"."creator_id") FROM "projects" INNER JOIN "services" ON "services"."project_id" = "projects"."id" INNER JOIN "project_feature_usages" ON "project_feature_usages"."project_id" = "projects"."id" WHERE "services"."type" = $1 AND "services"."active" = $2 AND "project_feature_usages"."jira_dvcs_cloud_last_sync_at" IS NOT NULL /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT COUNT(DISTINCT "projects"."creator_id") FROM "projects" INNER JOIN "services" ON "services"."project_id" = "projects"."id" INNER JOIN "project_feature_usages" ON "project_feature_usages"."project_id" = "projects"."id" WHERE "services"."type" = $1 AND "services"."active" = $2 AND "project_feature_usages"."jira_dvcs_cloud_last_sync_at" IS NOT NULL AND "projects"."creator_id" BETWEEN $3 AND $4 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT MIN("projects"."creator_id") FROM "projects" INNER JOIN "services" ON "services"."project_id" = "projects"."id" INNER JOIN "project_feature_usages" ON "project_feature_usages"."project_id" = "projects"."id" WHERE "services"."type" = $1 AND "services"."active" = $2 AND "project_feature_usages"."jira_dvcs_server_last_sync_at" IS NOT NULL /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT MAX("projects"."creator_id") FROM "projects" INNER JOIN "services" ON "services"."project_id" = "projects"."id" INNER JOIN "project_feature_usages" ON "project_feature_usages"."project_id" = "projects"."id" WHERE "services"."type" = $1 AND "services"."active" = $2 AND "project_feature_usages"."jira_dvcs_server_last_sync_at" IS NOT NULL /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
SELECT COUNT(DISTINCT "projects"."creator_id") FROM "projects" INNER JOIN "services" ON "services"."project_id" = "projects"."id" INNER JOIN "project_feature_usages" ON "project_feature_usages"."project_id" = "projects"."id" WHERE "services"."type" = $1 AND "services"."active" = $2 AND "project_feature_usages"."jira_dvcs_server_last_sync_at" IS NOT NULL AND "projects"."creator_id" BETWEEN $3 AND $4 /*application:test,controller:application_settings,action:usage_data,correlation_id:6a0c0fa1ca2505711e59296537dcdff3*/
