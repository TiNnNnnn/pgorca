...
SELECT
  ...
  CASE WHEN COUNT(DISTINCT c.c_customer_id) > 0 THEN 'Active' ELSE 'Inactive' END AS customer_status
...
LEFT JOIN InventoryStats AS i
  ON r.ws_item_sk = i.inv_item_sk
GROUP BY
  ca.ca_address_id
HAVING
