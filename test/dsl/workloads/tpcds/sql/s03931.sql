WITH CustomerStats AS (
  ...
  LEFT JOIN IncomeDetails AS id
    ON cs.cd_purchase_estimate BETWEEN id.ib_lower_bound AND id.ib_upper_bound
  LEFT JOIN ReturnStats AS rs
    ON cs.c_customer_sk = rs.sr_customer_sk
)
SELECT
  fs.c_customer_sk,
  fs.c_first_name,
