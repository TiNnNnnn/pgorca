WITH StringStats AS (
  ...
  SELECT
    ...
    VoteCount,
    CASE
      WHEN BodyLength > 2000
      THEN 'Long Body'
      WHEN BodyLength BETWEEN 1000 AND 2000
      THEN 'Medium Body'
      ELSE 'Short Body'
    END AS BodySizeCategory,
    CASE WHEN TitleLength > 100 THEN 'Long Title' ELSE 'Short Title' END AS TitleSizeCategory
  FROM StringStats
)
SELECT
  BodySizeCategory,
