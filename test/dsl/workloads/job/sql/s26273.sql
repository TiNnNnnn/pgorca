WITH movie_details AS (
  ...
  LEFT JOIN keyword AS ko
    ON mk.keyword_id = ko.id
  WHERE
    mt.production_year >= 2000 AND NOT ak.name IS NULL AND cn.country_code = 'USA'
