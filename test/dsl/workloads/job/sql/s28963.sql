WITH RankedTitles AS (
  ...
  FROM RankedTitles AS year
  JOIN FilteredActors AS actors
    ON year.title = actors.movie_title AND year.production_year = actors.production_year
  GROUP BY
    year.production_year
)
SELECT
