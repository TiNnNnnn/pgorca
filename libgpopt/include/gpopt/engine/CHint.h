...
private:
	...
	// Maximum number of non-noop alternatives generated by DSL rules in one
	// optimization. Zero preserves the unbounded behavior.
	ULONG m_ulDSLRuleMaxAlternatives;
...
public:
	...
	ULONG
	UlDSLRuleMaxAlternatives() const
	{
		return m_ulDSLRuleMaxAlternatives;
	}
