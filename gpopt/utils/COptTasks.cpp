...
/* plan_hint_hook_type is GPDB-only */

// Check one-to-one mapping of row hint types
/* RVT_* / plan_hint_hook are GPDB-only — assertions skipped in PG18 */
...
#if 0  /* pg_hint_plan types not available in PG18 -- stub below */
//---------------------------------------------------------------------------
//	@function:
//		GenerateJoinNodes
//
...
#endif /* pg_hint_plan stub */

// Stub: no hint-plan support in PG18 mode
CPlanHint *
COptTasks::GetPlanHints(CMemoryPool *mp, Query * /*query*/)
{
	(void) mp;
